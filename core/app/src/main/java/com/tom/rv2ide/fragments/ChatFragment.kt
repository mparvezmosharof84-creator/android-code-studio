...
class ChatFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // আপনার দেওয়া ব্যক্তিগত API Key স্বয়ংক্রিয়ভাবে মেমোরিতে ইনজেক্ট করা
        val prefs = requireContext().getSharedPreferences("ai_preferences", Context.MODE_PRIVATE)
        prefs.edit()
            .putString("api_key", "AQ.Ab8RN6JtbJDWXrBmn0OcRxopbMSmj610JyEl0h3sFu6yQYgBUw")
            .putString("gemini_api_key", "AQ.Ab8RN6JtbJDWXrBmn0OcRxopbMSmj610JyEl0h3sFu6yQYgBUw")
            .putString("apiKey", "AQ.Ab8RN6JtbJDWXrBmn0OcRxopbMSmj610JyEl0h3sFu6yQYgBUw")
            .apply()
